...
import 'package:cosmeticsnew/main.dart';
import 'package:cosmeticsnew/models/Anuncio.dart';
import 'package:cosmeticsnew/util/Configuracoes.dart';
import 'package:cosmeticsnew/views/widgets/ItemAnuncio.dart';
          ...
          Row(children: <Widget>[
            ...
            Expanded(
              child: DropdownButtonHideUnderline(
                  child: Center(
                    child: DropdownButton(
                      iconEnabledColor: Color(0xfff50057),
                ...
                case ConnectionState.done:
                  ...
                  if( querySnapshot.documents.length == 0 ){
                    return Container(
                      ...
                      child: Text("Nenhum Produto! :( ", style: TextStyle(
                          fontSize: 20,
